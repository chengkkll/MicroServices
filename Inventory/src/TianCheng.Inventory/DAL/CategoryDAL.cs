...
namespace TianCheng.Inventory.DAL
{
    ...
    /// 主分类信息 [数据持久化]
    /// </summary>
    [DBMapping("stock_category")]
    public class CategoryDAL : MongoOperation<CategoryInfo, CategoryQuery>
    {
        #region 查询方法
        /// <summary>
        /// 按条件查询数据
        ...
        /// <returns></returns>
        protected override IQueryable<CategoryInfo> BaseFilter(CategoryQuery filter)
        {
            var query = Queryable();
