...
namespace TianCheng.Inventory.DAL
{
    ...
    /// 商品库存信息 [数据持久化]
    /// </summary>
    [DBMapping("stock_inventory_goods")]
    public class InventoryGoodsDAL : MongoOperation<InventoryGoodsInfo, InventoryQuery>
    {
        #region 查询方法
        /// <summary>
        /// 按条件查询数据
        ...
        /// <returns></returns>
        protected override IQueryable<InventoryGoodsInfo> BaseFilter(InventoryQuery filter)
        {
            var query = Queryable();
