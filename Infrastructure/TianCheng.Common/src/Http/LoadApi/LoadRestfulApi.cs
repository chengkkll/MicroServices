...
namespace TianCheng.Common
{
    ...
    public class LoadRestfulApi
    {
        ...
        /// <returns></returns>
        internal static ApiMethodType GetMethodType(string method)
        {
        ...
        /// <returns></returns>
        public static async Task<string> Load(string methodName, string apiUrl, object postObject, string token = "", string tokenScheme = "Bearer")
        {
            return await Load(GetMethodType(methodName), apiUrl, postObject, token, tokenScheme);
        }
        /// <summary>
        /// 调用api请求处理
        /// </summary>
        ...
        /// <param name="tokenScheme"></param>
        /// <returns></returns>
        internal static async Task<string> Load(ApiMethodType methodType, string apiUrl, object postObject, string token = "", string tokenScheme = "Bearer")
        {
            try
            {
