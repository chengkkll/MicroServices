...
namespace TianCheng.Organization.Services
{
    ...
    public class EmployeeService : MongoBusinessService<EmployeeDAL, EmployeeInfo, EmployeeQuery>,
        IDeleteService<EmployeeInfo, EmployeeDAL>,
        IOccupyService<EmployeeInfo, EmployeeDAL>
    {
        #region 构造方法
        /// <summary>
        /// 构造方法
        ...
        /// </summary>
        /// <returns></returns>
        public List<EmployeeGroupByDepartment> GetEmployeeByDepartment(StringTokenInfo logonInfo = null)
        {
        ...
        protected override void SavingCheck(EmployeeInfo info, TokenBase logonInfo)
        {
            // 处理角色的验证
            if (RequiredRole)
            {
        ...
        /// <param name="info"></param>
        /// <param name="logonInfo"></param>
        protected override void Saving(EmployeeInfo info, TokenBase logonInfo)
        {
            //设置员工状态
            ...
            if (info.Department != null && !string.IsNullOrWhiteSpace(info.Department.Id))
            {
                ...
                DepartmentInfo depInfo = departmentDAL.SingleById(depId);
                if (depInfo == null)
                {
            ...
            if (info.Role != null && !string.IsNullOrWhiteSpace(info.Role.Id))
            {
                ...
                RoleInfo role = roleDAL.SingleById(roleId);
                if (role == null)
                {
        ...
        /// <returns></returns>
        public StringTokenInfo GetLogonInfo(string employeeId)
        {
            var employee = SingleById(employeeId);
        ...
        /// </summary>
        /// <returns></returns>
        public StringTokenInfo GetAdminLogonInfo()
        {
            EmployeeInfo admin = GetAdminstrator();
            return new StringTokenInfo
            {
                EmployeeId = admin.IdString,
                Name = admin.Name,
        ...
        public ResultView Test()
        {
            ...
            Dal.UpdateMany(e => e.Id == mim.ConvertID("5f9463015fc0fc2a9425fbc7"), e => new EmployeeInfo { Code = "001" });
